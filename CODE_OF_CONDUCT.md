...
will take appropriate and fair corrective action in response to any behaviour that they deem inappropriate,
...
maintainers. Open the profile of any maintainer listed in the repository's contribution history and use
GitHub's private contact options, or email the address published in the repository profile. All complaints
...
the violation and an explanation of why the behaviour was inappropriate. A public apology may be requested.
...
unsolicited interaction with those enforcing the Code of Conduct, is allowed during this period. Violating
...
inappropriate behaviour, harassment of an individual, or aggression toward or disparagement of classes of
individuals.
